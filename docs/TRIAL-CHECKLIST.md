...
6. 通知记录：顶部今日触达漏斗可点选；筛选 今日 / 发送失败 / 到件 / 滞留 / 未私信 / 已私信 / 私信失败；本页可一键补发未私信  
...
12. 批量入库：支持 Excel 粘贴/表头/+86；可「仅预检」或「预检并导入」；预检/成功/失败可导出  
13. 出库待收款：工作台/交班/库存详情均可直达出库收款；须选方式并勾选「已当面收妥」；成功后可复制收款话术  
14. 工作台「今日收款日结」显示已收金额与笔数，可进明细  
